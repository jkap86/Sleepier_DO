...
const Players3 = ({
    ...
    const { itemActive3: itemActive, lineupType } = useSelector(state => state.players);
        ...
        ?.map(roster => {
            ...
            return {
                ...
                list: [
                    ...
                    {
                        text: parseFloat(fpts + '.' + fpts_decimal).toLocaleString("en-US", { maximumFractionDigits: 2, minimumFractionDigits: 2 }),
                        colSpan: 3
                    }
                ]
            }
    ...
    const leagueInfo_body = [
        ...
        ...(league.scoring_settings
            && Object.keys(league.scoring_settings)
                .filter(setting => (league.scoring_settings[setting] !== default_scoring_settings[setting] || scoring_settings_display.includes(setting)))
                .map(setting => {
                    return {
                        id: setting,
                        list: [
                            ...
                            {
                                text: league.scoring_settings[setting].toLocaleString(),
                                colSpan: 11
                            }
                        ]
                    }
    ...
    return <>
        ...
        <TableMain
            ...
            setItemActive={(value) => dispatch(setState({ itemActive3: value }, 'PLAYERS'))}
        />
        {
            active_roster
                ? lineupType === 'Matchups'
